...
public class DentifriceVolant extends Personnage {
    ...
    public DentifriceVolant(int x, int y, Terrain terrain, Joueur joueur) {
        super(x, y, 46, 56, 3, 3, terrain); // Commence plus haut
        this.joueur = joueur;
        setDansLesAirs(true);
    }
    ...
    public void seDeplacer() {
        ...
        if (compteur >= 8) {
            ...
            deplacerHorizontalementVersJoueur(distanceX);
     ...
     */
    public void deplacerHorizontalementVersJoueur(int distanceX) {
        int nouveauX = getX();
