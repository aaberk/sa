...
// 6 = pelouse extremite gauche
    ...
    public int versionBrisee(int type) {
        switch (type) {
            case 2: return 12; // pelouse → pelouse brisée
            case 3: return 13; // terre → terre brisée
            case 4: return 14; // cookie → cookie brisé
            case 5: return 15; // extrémité droite → brisée
