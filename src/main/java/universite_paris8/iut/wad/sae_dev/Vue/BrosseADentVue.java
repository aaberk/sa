...
public class BrosseADentVue extends PersonnageVue {
    ...
    public void chargerImages() {
        ...
        this.imageG = new Image(getClass().getResource(chemin + "Brosse.png").toExternalForm());
        this.imageImmobileG = new Image(getClass().getResource(chemin + "Brosse.png").toExternalForm());
        this.imageImmobileD = new Image(getClass().getResource(chemin + "Brosse.png").toExternalForm());
    }
