...
public class VieVue {
    ...
    public VieVue(Joueur joueur, HBox vies) {
        ...
        this.coeurPlein = new Image(getClass().getResource("/universite_paris8/iut/wad/sae_dev/images/coeurVie.png").toExternalForm());
        this.coeurVide = new Image(getClass().getResource("/universite_paris8/iut/wad/sae_dev/images/coeurVide.png").toExternalForm());

        for (int i = 0; i < 3; i++) {
            ImageView coeur = new ImageView(coeurPlein);
            coeur.setFitWidth(32);
            coeur.setFitHeight(32);
            coeurs.add(coeur);
