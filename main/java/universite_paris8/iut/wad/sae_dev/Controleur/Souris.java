        ...
        if (event.getEventType() == MouseEvent.MOUSE_CLICKED) {
            ...
            if (x >= 0 && x < terrain.largeur() && y >= 0 && y < terrain.hauteur()) {
                ...
                if (event.getButton() == MouseButton.SECONDARY) {
                    ...
                    TypeMateriaux materiauxRequis = BlocMapper.typeBlocVersMateriaux(blocSelectionne);
                    ...
                    if (terrain.estBrise(typeActuel)) {
                        if (BlocMapper.estBlocCollectable(typeActuel)) {
                            TypeMateriaux materiauxRecupere = BlocMapper.typeBlocVersMateriaux(typeActuel);
