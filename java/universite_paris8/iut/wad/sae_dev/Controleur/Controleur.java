...
public class Controleur implements Initializable {
    ...
    public void initialiserBtnCrafting() {
        try {
            ...
            System.out.println("⚠️ Erreur chargement image craft.png : " + e.getMessage());
        }
    }
    ...
    public void initialiserModeles() {
        ...
        pnjDonut = new PnjDonut(720, 200, joueur, terrain);
    ...
    public void creerProjectile() {
        ...
        ProjectileDentifriceVue projectileVue = new ProjectileDentifriceVue(projectileDentifrice, this.pane);
        this.projectiles.add(projectileDentifrice);
        this.projectilesVue.add(projectileVue);
    }
    ...
    public void gererVie() {
        if (this.brosseADent.toucheJoueur()) {
            this.joueur.retirerVie();
        }

        for(Projectile projectile : this.projectiles) {
            if (projectile.toucheJoueur(this.joueur)) {
                this.joueur.retirerVie();
            }
        }
    ...
    public void tirerFlecheDuJoueur(int direction) {
        ...
        FlecheArcVue vue = new FlecheArcVue(fleche, this.pane);
